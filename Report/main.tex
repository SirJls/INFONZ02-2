...
% \textsc{other author} \\[1ex] % Second author's name
% \normalsize Institution \\ % Second author's institution
% \normalsize \href{mailto:email@email.com}{email@email.com} % Second author's email address
}
